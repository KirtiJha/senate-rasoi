...
export interface SignUpInput {
  ...
  newCommunity?: { id?: string; name: string; address: string; lat?: number | null; lon?: number | null; osmPlaceId?: string | null; city?: string | null; state?: string | null; pincode?: string | null };
