...
export default function LandingScreen() {
  ...
  // Phones get a welcome, not a brochure. Everything below this line is the
  // marketing page, which only earns its layout at tablet width and up.
  if (!isWide) return <PhoneWelcome />;
