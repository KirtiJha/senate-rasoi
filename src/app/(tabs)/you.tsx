    ...
    <View className="flex-1 bg-bg">
      ...
      <View className="px-4 pb-2 pt-3">
        <Container>
          ...
          {isAdmin ? (
            <Pressable accessibilityRole="button" accessibilityLabel="Open" onPress={() => router.push('/admin')} className="mt-3 flex-row items-center gap-2 rounded-2xl border border-line bg-surface px-4 py-3">
